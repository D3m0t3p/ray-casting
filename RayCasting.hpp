...
public:
	...
	float rayCasting(sf::Vector2f& position,float angle, const std::vector<std::vector<int>>& labyrinth, bool  wantPlaceInLab = false)const;	//retourn la distance jusque au mur rencontré
